...
app.use(
  cors({
    origin: process.env.CLIENT_URL || "https://agrivai.abenable.tech",
    credentials: true,
  })
);

// Handle preflight requests
app.options(new RegExp(".*"), cors({ origin: process.env.CLIENT_URL || "https://agrivai.abenable.tech", credentials: true }));
